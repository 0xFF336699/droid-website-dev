...
var Toolbar = __webpack_require__(21436);
...
var Avatar_Avatar = __webpack_require__(9767);
...
// EXTERNAL MODULE: ../../node_modules/.pnpm/@mui+icons-material@6.4.12_@mui+material@6.4.12_@emotion+react@11.14.0_@types+react@19.1.8_re_5ewkm5t5g27pzq5tz62v6ktvti/node_modules/@mui/icons-material/esm/People.js
var People = __webpack_require__(53755);
...
var room = __webpack_require__(56092);
...
// EXTERNAL MODULE: ../../node_modules/.pnpm/@mui+icons-material@6.4.12_@mui+material@6.4.12_@emotion+react@11.14.0_@types+react@19.1.8_re_5ewkm5t5g27pzq5tz62v6ktvti/node_modules/@mui/icons-material/esm/MoreVert.js
var MoreVert = __webpack_require__(52202);
// EXTERNAL MODULE: ../../libs/fanfanlo/dist/src/watcher/useProxyWatch.js
var watcher_useProxyWatch = __webpack_require__(61840);
...
// EXTERNAL MODULE: ../../node_modules/.pnpm/@mui+material@6.4.12_@emotion+react@11.14.0_@types+react@19.1.8_react@19.1.0__@emotion+styled_7n6ip7adzgskiknwagt7k5dnla/node_modules/@mui/material/Button/Button.js + 3 modules
var Button = __webpack_require__(28669);
;// ./src/im/components/meeting/MeetingCreateDialog.tsx
 ...
 */ function MeetingCreateDialog(param) {
...
// EXTERNAL MODULE: ./src/im/element-call/meetingEvent.types.ts
var meetingEvent_types = __webpack_require__(1819);
;// ./src/im/element-call/meetingEvent.ts
 ...
 */ async function sendStartMeetingEvent(roomId, options) {
    var _matrixClient_client_getUserId, _matrixClient_client;
    const callId = generateCallId();
    const userId = ((_matrixClient_client_getUserId = (_matrixClient_client = client/* matrixClient */.X.client).getUserId) === null || _matrixClient_client_getUserId === void 0 ? void 0 : _matrixClient_client_getUserId.call(_matrixClient_client)) || '';
    const now = Date.now();
    const content = {
        state: 'started',
        call_id: callId,
        initiator: userId,
        type: (options === null || options === void 0 ? void 0 : options.type) || 'normal',
        started_at: now
    };
    // @ts-ignore: 兼容自定义事件类型
    await client/* matrixClient */.X.client.sendEvent(roomId, meetingEvent_types/* MATRIX_EVENT_TYPE_MEETING */.E, content, '');
    return callId;
}
/**
 * 发送会议结束事件（可选扩展）
 */ async function sendEndMeetingEvent(roomId, callId) {
    var _matrixClient_client_getUserId, _matrixClient_client;
    const userId = ((_matrixClient_client_getUserId = (_matrixClient_client = client/* matrixClient */.X.client).getUserId) === null || _matrixClient_client_getUserId === void 0 ? void 0 : _matrixClient_client_getUserId.call(_matrixClient_client)) || '';
    const now = Date.now();
    const content = {
...
;// ./src/im/components/room/HeaderExtraButton.tsx
 ...
 */ function CreateMeetingMenuItem() {
    var _roomData_meetingStateMap_roomId;
    const router = (0,next_router.useRouter)();
    // roomId 可从路由参数获取
    const roomId = typeof router.query.id === 'string' ? router.query.id : '';
    // useProxyWatch 返回 [value, ...]，只取第一个值
    const [disabled] = (0,watcher_useProxyWatch/* useProxyWatch */.x)(data/* roomData */.S.meetingStateMap, [
        roomId,
        'meetingActive'
    ], ((_roomData_meetingStateMap_roomId = data/* roomData */.S.meetingStateMap[roomId]) === null || _roomData_meetingStateMap_roomId === void 0 ? void 0 : _roomData_meetingStateMap_roomId.meetingActive) || false);
    ...
    async function handleDialogSubmit(data) {
        ...
        if (!roomId) return;
        // 真正发送会议事件
        await meetingEvent.sendStartMeetingEvent(roomId, {
            type: 'normal'
        });
    ...
    return /*#__PURE__*/ (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
        children: [
            ...
            /*#__PURE__*/ (0,jsx_runtime.jsx)(MeetingCreateDialog, {
                open: dialogOpen,
    ...
    return /*#__PURE__*/ (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
        children: [
            /*#__PURE__*/ (0,jsx_runtime.jsx)(IconButton/* default */.A, {
                ...
                size: "large",
                children: /*#__PURE__*/ (0,jsx_runtime.jsx)(MoreVert/* default */.A, {})
            }),
            /*#__PURE__*/ (0,jsx_runtime.jsx)(Menu/* default */.A, {
                anchorEl: anchorEl,
                open: open,
                onClose: ()=>setAnchorEl(null),
                children: /*#__PURE__*/ (0,jsx_runtime.jsx)(CreateMeetingMenuItem, {})
            })
        ]
    });
}
    ...
    return /*#__PURE__*/ (0,jsx_runtime.jsx)(AppBar_AppBar/* default */.A, {
        ...
        children: /*#__PURE__*/ (0,jsx_runtime.jsxs)(Toolbar/* default */.A, {
            children: [
                ...
                /*#__PURE__*/ (0,jsx_runtime.jsx)(HeaderExtraButton, {})
            ]
        })
    });
}
...
/* provided dependency */ var process = __webpack_require__(8643);
...
var messageUtils = __webpack_require__(98195);
...
// EXTERNAL MODULE: ../../node_modules/.pnpm/@mui+material@6.4.12_@emotion+react@11.14.0_@types+react@19.1.8_react@19.1.0__@emotion+styled_7n6ip7adzgskiknwagt7k5dnla/node_modules/@mui/material/InputAdornment/InputAdornment.js + 1 modules
var InputAdornment = __webpack_require__(81890);
// EXTERNAL MODULE: ../../node_modules/.pnpm/@mui+icons-material@6.4.12_@mui+material@6.4.12_@emotion+react@11.14.0_@types+react@19.1.8_re_5ewkm5t5g27pzq5tz62v6ktvti/node_modules/@mui/icons-material/esm/AttachFile.js
var AttachFile = __webpack_require__(51175);
// EXTERNAL MODULE: ../../node_modules/.pnpm/@mui+icons-material@6.4.12_@mui+material@6.4.12_@emotion+react@11.14.0_@types+react@19.1.8_re_5ewkm5t5g27pzq5tz62v6ktvti/node_modules/@mui/icons-material/esm/EmojiEmotions.js
var EmojiEmotions = __webpack_require__(92824);
// EXTERNAL MODULE: ../../node_modules/.pnpm/@mui+icons-material@6.4.12_@mui+material@6.4.12_@emotion+react@11.14.0_@types+react@19.1.8_re_5ewkm5t5g27pzq5tz62v6ktvti/node_modules/@mui/icons-material/esm/LocationOn.js
var LocationOn = __webpack_require__(99846);
// EXTERNAL MODULE: ../../node_modules/.pnpm/@mui+icons-material@6.4.12_@mui+material@6.4.12_@emotion+react@11.14.0_@types+react@19.1.8_re_5ewkm5t5g27pzq5tz62v6ktvti/node_modules/@mui/icons-material/esm/Send.js
var Send = __webpack_require__(45386);
// EXTERNAL MODULE: ./src/im/client/index.ts + 1 modules
var im_client = __webpack_require__(71504);
...
const locationMessageUtils = {
    ...
    send: async function(roomId, latitude, longitude) {
        ...
        const message = {
            id: tempId,
            type: 'm.location',
            sender: ((_matrixClient_client = client/* matrixClient */.X.client) === null || _matrixClient_client === void 0 ? void 0 : _matrixClient_client.getUserId()) || '',
            timestamp: Date.now(),
            roomId,
            content,
            status: 'sending'
        ...
        if (!client/* matrixClient */.X.client) {
            logger.error('Matrix client is not initialized');
            throw new Error('Matrix client is not initialized');
        }
        try {
            const eventId = await client/* matrixClient */.X.client.sendMessage(roomId, {
                msgtype: 'm.location',
                body: content.body,
...
// EXTERNAL MODULE: ../../node_modules/.pnpm/next@15.3.5_@babel+core@7.28.0_babel-plugin-macros@3.1.0_react-dom@19.1.0_react@19.1.0__react@19.1.0_sass@1.89.2/node_modules/next/dynamic.js
var dynamic = __webpack_require__(71202);
...
const BaiduMapView = dynamic_default()(()=>__webpack_require__.e(/* import() */ 6600).then(__webpack_require__.bind(__webpack_require__, 66600)).then((m)=>m.BaiduMapView), {
    loadableGenerated: {
        webpack: ()=>[
                /*require.resolve*/(66600)
            ]
    },
    ssr: false
});
const GoogleMapView = dynamic_default()(()=>__webpack_require__.e(/* import() */ 88).then(__webpack_require__.bind(__webpack_require__, 70088)).then((m)=>m.GoogleMapView), {
    loadableGenerated: {
        webpack: ()=>[
                /*require.resolve*/(70088)
            ]
    },
    ssr: false
});
const AmapMapView = dynamic_default()(()=>__webpack_require__.e(/* import() */ 3140).then(__webpack_require__.bind(__webpack_require__, 93140)).then((m)=>m.AmapMapView), {
    loadableGenerated: {
        webpack: ()=>[
                /*require.resolve*/(93140)
            ]
    },
    ssr: false
});
...
function MessageInput(param) {
    ...
    const sendMessage = async ()=>{
        ...
        try {
            ...
            await im_client/* matrixClient */.Xi.client.sendTextMessage(roomId, message.trim());
            setMessage('');
...
// EXTERNAL MODULE: ../../node_modules/.pnpm/@mui+material@6.4.12_@emotion+react@11.14.0_@types+react@19.1.8_react@19.1.0__@emotion+styled_7n6ip7adzgskiknwagt7k5dnla/node_modules/@mui/material/Badge/Badge.js + 3 modules
var Badge = __webpack_require__(85380);
 ...
 */ async function loadHistoryByEventId(roomId, eventId) {
    ...
    if (!client/* matrixClient */.X.client) return {
        events: [],
        isEnd: true,
        timeline: null
    };
    // 1. 获取 Room 实例
    const room = await client/* matrixClient */.X.client.getRoom(roomId);
    if (!room) {
    ...
    const timeline = await client/* matrixClient */.X.client.getEventTimeline(timelineSet, eventId);
    if (!timeline) {
        throw new Error('timeline not found for event: ' + eventId);
    }
    // 4. 向前分页加载历史
    const hasMore = await client/* matrixClient */.X.client.paginateEventTimeline(timeline, {
        backwards: true,
        limit
    });
...
;// ./src/im/components/meeting/MeetingPanel.tsx
...
function MeetingPanel(param) {
    let { roomId } = param;
    const [meetingActive] = (0,watcher_useProxyWatch/* useProxyWatch */.x)(data/* roomData */.S.meetingStateMap, [
        roomId,
        'meetingActive'
    ], false);
    const [meetingId] = (0,watcher_useProxyWatch/* useProxyWatch */.x)(data/* roomData */.S.meetingStateMap, [
        roomId,
        'meetingId'
    ], undefined);
    const { t } = (0,src.useTranslation)('homepage/im/components/meeting/content');
    const router = (0,next_router.useRouter)();
    ...
    return /*#__PURE__*/ (0,jsx_runtime.jsxs)(Box_Box/* default */.A, {
        ...
        children: [
            /*#__PURE__*/ (0,jsx_runtime.jsx)(Typography_Typography/* default */.A, {
                variant: "body1",
                children: t('MeetingPanel.meetingOngoing')
            }),
            /*#__PURE__*/ (0,jsx_runtime.jsx)(Button/* default */.A, {
                variant: "contained",
                color: "primary",
                onClick: handleJoinMeeting,
                children: t('MeetingPanel.joinMeeting')
            })
        ]
    });
}
        ...
        children: [
            ...
            /*#__PURE__*/ (0,jsx_runtime.jsx)(Box_Box/* default */.A, {
                ...
                children: /*#__PURE__*/ (0,jsx_runtime.jsxs)(Box_Box/* default */.A, {
                    ...
                    children: [
                        /*#__PURE__*/ (0,jsx_runtime.jsx)(MeetingPanel, {
                            roomId: roomId
                        }),
                        /*#__PURE__*/ (0,jsx_runtime.jsx)(MessageListVirtuoso, {
                            roomId: roomId
                        })
                    ]
                })
...
/***/ ((__unused_webpack_module, __unused_webpack_exports, __webpack_require__) => {
    ...
    (window.__NEXT_P = window.__NEXT_P || []).push([
      "/im/room",
      function () {
        return __webpack_require__(43734);
      }
    ]);
    if(false) {}
...
/******/ __webpack_require__.O(0, [112,6977,9893,9151,2203,3390,7313,8771,5881,9964,8227,636,6593,8792], () => (__webpack_exec__(52960)));
/******/ var __webpack_exports__ = __webpack_require__.O();
/******/ _N_E = __webpack_exports__;
/******/ }
]);
//# sourceMappingURL=room-b1127864db6c3648.js.map